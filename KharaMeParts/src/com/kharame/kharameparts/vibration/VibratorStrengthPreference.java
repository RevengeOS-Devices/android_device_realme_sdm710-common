 ...
 */
package com.kharame.kharameparts.vibration;
...
public class VibratorStrengthPreference extends Preference implements
	...
	private void setValue(String newValue, boolean withFeedback) {
        ...
        editor.putString(VibrationFragment.KEY_VIBSTRENGTH, newValue);
        editor.commit();
	    if (withFeedback) {
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(VibrationFragment.KEY_VIBSTRENGTH, "2700"); 
